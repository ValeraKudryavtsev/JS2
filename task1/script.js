// список товаров с параметрами из методички
const goods = [
...
// функция, формирующая html-разметку для товара
const renderGoodsItem = (title, price, img, caption = 'Known for her sculptural takes on traditional tailoring, Australian arbiter of cool Kym Ellery teams up with Moda Operandi.') => {
    return `<li class="goods__item">
                <div class="goods__img-box">
                    <img class="goods__img" src="${img}" alt="Product img">
                ...
                <h3 class="goods__item-title">${title}</h3>
                <p class="goods__item-text">${caption}</p>
                <p class="goods__item-price">$${price}</p>
            </li>`;
};

// функция, которая добавляет товары в html-документ
// * убрать запятые (сделано)
// * * накатить стили (сделано)
// * * * добавить значения по умолчанию в функции (сделано)
